...
def get_cities(state_id):
    """
    Gives the list of all cities of a specific State.
    """
    all_cities = []
...
def get_city(city_id):
    """
    Gets a specific city based on id
    """
...
def post_city(state_id):
    ...
    city_instance.state_id = state.id
    city_instance.save()
    return make_response(jsonify(city_instance.to_dict()), 201)
